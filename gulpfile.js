...
gulp.task('develop', (cb) => {
    runSequence('clean-dev', 'less', 'copy-dev-style', 'webpack', 'copy-dev-js-plugin', 'copy-dev-js-web', cb);
});

gulp.task('dev', function () {
    runSequence('clean-dev', 'less', 'copy-dev-style', 'copy-dev-js-plugin', 'copy-dev-js-web');
    ...
    gulp.watch(['./public/src/js/plugins/**', './public/src/js/admin', './public/src/js/web'], function (event) {
        runSequence('copy-dev-js-plugin', 'copy-dev-js-web');
    });
